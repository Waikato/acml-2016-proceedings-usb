...
BLOG_EMAIL = "acml2016@waikato.ac.nz"
BLOG_DESCRIPTION = "The 8th Asian Conference on Machine Learning November 16-18, Hamilton, New Zealand"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ((
          ("http://acml-conf.org/2016/", "Conference website"),
...
#THEME = "bootstrap3"
THEME = "bootstrap.acml"  # base on bootstrap3
...
#    ]
    'default': [
        "rsync -rav --delete output/ --exclude '.ht*' ../acml-2016-proceedings-usb.out",
    ]
}
